    ...
    public static Value evaluate(Exp exp, CPFact in) {
        ...
        if (exp instanceof BinaryExp b) {
            ...
            if (canHoldInt(operand1) && canHoldInt(operand2)) {
                if (exp instanceof ArithmeticExp a && (a.getOperator() == ArithmeticExp.Op.DIV || a.getOperator() == ArithmeticExp.Op.REM) && in.get(operand2).isConstant() && in.get(operand2).getConstant() == 0) {
